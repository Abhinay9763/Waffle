...
export default function HodEditExamPage() {
    ...
    return (
      <div className="flex flex-1 items-center justify-center px-4">
        <div className="w-full max-w-md rounded-xl border border-red-900/50 bg-red-950/30 p-5">
          ...
          <Link href="/hod/exams" className="mt-3 inline-block text-xs text-zinc-300 hover:text-zinc-100">
            Back to exams
          </Link>
        </div>
      </div>
    ...
    return (
      <div className="flex flex-1 items-center justify-center px-4">
        <div className="w-full max-w-md rounded-xl border border-zinc-800 bg-zinc-900/40 p-5">
          ...
          <p className="mt-2 text-sm text-zinc-400">You can only modify your own upcoming exams.</p>
          <Link href="/hod/exams" className="mt-3 inline-block text-xs text-zinc-300 hover:text-zinc-100">
            Back to exams
          </Link>
        </div>
  ...
  return (
    <ExamScheduleForm
      mode="edit"
      examId={examId}
      examsBasePath="/hod/exams"
      papersBasePath="/hod/papers"
      initialData={{
        name: exam.name,
