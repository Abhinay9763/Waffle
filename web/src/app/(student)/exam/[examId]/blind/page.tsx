...
import BlindExamGate from "@/components/student/BlindExamGate";
import { ExamStructure } from "@/components/student/types";
import { API } from "@/lib/config";

export default async function StudentBlindExamPage({
  params,
}: {
    ...
    return (
      <div className="flex h-full items-center justify-center px-6 text-center">
        <div className="space-y-3">
          ...
          <Link href="/student" className="text-xs text-yellow-400 hover:text-yellow-300">
            Back to dashboard
          </Link>
        </div>
      </div>
  ...
  return <BlindExamGate exam={examData} />;
}
